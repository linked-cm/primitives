...
const SubTrigger = React.forwardRef(({ className, inset, children, ...props }, ref) => (React.createElement(DropdownMenuPrimitive.SubTrigger, { ref: ref, className: cl(style.SubTrigger, inset && style.Inset, className), ...props },
    children,
...
const Content = React.forwardRef(({ className, align = 'end', alignOffset = 0, sideOffset = 4, ...props }, ref) => (React.createElement(Portal, null,
    React.createElement(DropdownMenuPrimitive.Content, { ref: ref, align: align, alignOffset: alignOffset, sideOffset: sideOffset, className: cl(style.Content, className), ...props }))));
Content.displayName = DropdownMenuPrimitive.Content.displayName;
const Item = React.forwardRef(({ className, inset, ...props }, ref) => (React.createElement(DropdownMenuPrimitive.Item, { ref: ref, className: cl(style.Item, inset && style.Inset, className), ...props })));
Item.displayName = DropdownMenuPrimitive.Item.displayName;
const CheckboxItem = React.forwardRef(({ className, children, checked, ...props }, ref) => (React.createElement(DropdownMenuPrimitive.CheckboxItem, { ref: ref, className: cl(style.CheckboxItem, className), checked: checked, ...props },
...
const RadioItem = React.forwardRef(({ className, children, ...props }, ref) => (React.createElement(DropdownMenuPrimitive.RadioItem, { ref: ref, className: cl(style.RadioItem, className), ...props },
    React.createElement("span", { className: style.ItemIndicator },
        React.createElement(DropdownMenuPrimitive.ItemIndicator, null,
            React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const Label = React.forwardRef(({ className, inset, ...props }, ref) => (React.createElement(DropdownMenuPrimitive.Label, { ref: ref, className: cl(style.Label, inset && style.Inset, className), ...props })));
