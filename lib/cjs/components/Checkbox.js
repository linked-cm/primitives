...
const Checkbox = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(CheckboxPrimitive.Root, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Checkbox_module_css_1.default.Root, className) }, props),
        React.createElement(CheckboxPrimitive.Indicator, { className: (0, ClassNames_1.cl)(Checkbox_module_css_1.default.Indicator) },
            React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none" },
