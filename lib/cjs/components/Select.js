...
const Trigger = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(SelectPrimitive.Trigger, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Select_module_css_1.default.Trigger, size && Select_module_css_1.default[size], className) }, props),
        children,
...
const ScrollUpButton = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement(SelectPrimitive.ScrollUpButton, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Select_module_css_1.default.ScrollButton, className) }, props),
        React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const ScrollDownButton = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement(SelectPrimitive.ScrollDownButton, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Select_module_css_1.default.ScrollButton, className) }, props),
        React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const Content = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(SelectPrimitive.Portal, null,
        React.createElement(SelectPrimitive.Content, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Select_module_css_1.default.Content, position === 'popper' && Select_module_css_1.default.PopperContent, className), position: position }, props),
...
const Label = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement(SelectPrimitive.Label, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Select_module_css_1.default.Label, className) }, props)));
});
exports.Label = Label;
Label.displayName = SelectPrimitive.Label.displayName;
const Item = React.forwardRef((_a, ref) => {
    var { className, children } = _a, props = __rest(_a, ["className", "children"]);
    return (React.createElement(SelectPrimitive.Item, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Select_module_css_1.default.Item, className) }, props),
...
const Separator = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement(SelectPrimitive.Separator, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Select_module_css_1.default.Separator, className) }, props)));
});
