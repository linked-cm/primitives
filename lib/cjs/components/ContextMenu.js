...
const ContextMenu_module_css_1 = __importDefault(require("./ContextMenu.module.css"));
...
const Root = extend(ContextMenuPrimitive.Root, ContextMenu_module_css_1.default.Root);
exports.Root = Root;
const Trigger = extend(ContextMenuPrimitive.Trigger, ContextMenu_module_css_1.default.Trigger);
exports.Trigger = Trigger;
const SubContent = extend(ContextMenuPrimitive.SubContent, ContextMenu_module_css_1.default.SubContent);
exports.SubContent = SubContent;
const Separator = extend(ContextMenuPrimitive.Separator, ContextMenu_module_css_1.default.Separator);
exports.Separator = Separator;
const SubTrigger = React.forwardRef((_a, ref) => {
    var { className, inset, children } = _a, props = __rest(_a, ["className", "inset", "children"]);
    return (React.createElement(ContextMenuPrimitive.SubTrigger, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(ContextMenu_module_css_1.default.SubTrigger, inset && ContextMenu_module_css_1.default.Inset, className) }, props),
        children,
...
const Content = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(Portal, null,
        React.createElement(ContextMenuPrimitive.Content, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(ContextMenu_module_css_1.default.Content, className) }, props))));
});
exports.Content = Content;
Content.displayName = ContextMenuPrimitive.Content.displayName;
const Item = React.forwardRef((_a, ref) => {
    var { className, inset } = _a, props = __rest(_a, ["className", "inset"]);
    return (React.createElement(ContextMenuPrimitive.Item, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(ContextMenu_module_css_1.default.Item, inset && ContextMenu_module_css_1.default.Inset, className) }, props)));
});
exports.Item = Item;
Item.displayName = ContextMenuPrimitive.Item.displayName;
const CheckboxItem = React.forwardRef((_a, ref) => {
    var { className, children, checked } = _a, props = __rest(_a, ["className", "children", "checked"]);
    return (React.createElement(ContextMenuPrimitive.CheckboxItem, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(ContextMenu_module_css_1.default.CheckboxItem, className), checked: checked }, props),
...
const RadioItem = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(ContextMenuPrimitive.RadioItem, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(ContextMenu_module_css_1.default.RadioItem, className) }, props),
        React.createElement("span", { className: ContextMenu_module_css_1.default.ItemIndicator },
            React.createElement(ContextMenuPrimitive.ItemIndicator, null,
                React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const Label = React.forwardRef((_a, ref) => {
    var { className, inset } = _a, props = __rest(_a, ["className", "inset"]);
    return (React.createElement(ContextMenuPrimitive.Label, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(ContextMenu_module_css_1.default.Label, inset && ContextMenu_module_css_1.default.Inset, className) }, props)));
});
exports.Label = Label;
Label.displayName = ContextMenuPrimitive.Label.displayName;
const Shortcut = (_a) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return React.createElement("span", Object.assign({ className: (0, ClassNames_1.cl)(ContextMenu_module_css_1.default.RightSlot, className) }, props));
};
