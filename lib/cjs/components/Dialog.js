...
const Overlay = extend(DialogPrimitive.Overlay, Dialog_module_css_1.default.Overlay);
exports.Overlay = Overlay;
const Close = extend(DialogPrimitive.Close, Dialog_module_css_1.default.Close);
exports.Close = Close;
const Title = extend(DialogPrimitive.Title, Dialog_module_css_1.default.Title);
exports.Title = Title;
const Description = extend(DialogPrimitive.Description, Dialog_module_css_1.default.Description);
exports.Description = Description;
const Content = React.forwardRef((_a, ref) => {
    var { className, children, hideCloseIcon } = _a, props = __rest(_a, ["className", "children", "hideCloseIcon"]);
    return (React.createElement(Portal, null,
        React.createElement(Overlay, null),
        React.createElement(DialogPrimitive.Content, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Dialog_module_css_1.default.Content, className) }, props),
            children,
...
const Header = (_a) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement("div", Object.assign({ className: (0, ClassNames_1.cl)(Dialog_module_css_1.default.Header, className) }, props)));
};
exports.Header = Header;
Header.displayName = 'DialogHeader';
const Footer = (_a) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement("div", Object.assign({ className: (0, ClassNames_1.cl)(Dialog_module_css_1.default.Footer, className) }, props)));
};
