...
const Root = extend(TabsPrimitive.Root, Tabs_module_css_1.default.Root);
exports.Root = Root;
const List = extend(TabsPrimitive.List, Tabs_module_css_1.default.List);
exports.List = List;
const Trigger = extend(TabsPrimitive.Trigger, Tabs_module_css_1.default.Trigger);
exports.Trigger = Trigger;
const Content = extend(TabsPrimitive.Content, Tabs_module_css_1.default.Content);
