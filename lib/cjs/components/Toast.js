...
const Viewport = extend(ToastPrimitives.Viewport, Toast_module_css_1.default.Viewport);
exports.Viewport = Viewport;
const Root = extend(ToastPrimitives.Root, Toast_module_css_1.default.Root);
exports.Root = Root;
const Action = extend(ToastPrimitives.Action, Toast_module_css_1.default.Action);
exports.Action = Action;
const Title = extend(ToastPrimitives.Title, Toast_module_css_1.default.Title);
exports.Title = Title;
const Description = extend(ToastPrimitives.Description, Toast_module_css_1.default.Description);
exports.Description = Description;
const Close = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement(ToastPrimitives.Close, Object.assign({ ref: ref, className: (0, ClassNames_1.cl)(Toast_module_css_1.default.Close, className), "toast-close": "" }, props),
