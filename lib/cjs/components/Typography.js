...
const Typography = (_a) => {
    var { as: Component = 'p', size = 'default', className, children } = _a, props = __rest(_a, ["as", "size", "className", "children"]);
    const combinedClassName = (0, ClassNames_1.cl)(Typography_module_css_1.default.Root, Typography_module_css_1.default[size], className);
