...
var Accordion_module_css_1 = __importDefault(require("./Accordion.module.css"));
...
var Root = extend(AccordionPrimitive.Root, Accordion_module_css_1.default.Root);
exports.Root = Root;
var Item = extend(AccordionPrimitive.Item, Accordion_module_css_1.default.Item);
exports.Item = Item;
var Trigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(AccordionPrimitive.Header, { className: Accordion_module_css_1.default.Header },
        React.createElement(AccordionPrimitive.Trigger, __assign({ ref: ref, className: (0, ClassNames_1.cl)(Accordion_module_css_1.default.Trigger, className) }, props),
            children,
...
var Content = React.forwardRef(function (_a, ref) {
    var className = _a.className, children = _a.children, props = __rest(_a, ["className", "children"]);
    return (React.createElement(AccordionPrimitive.Content, __assign({ ref: ref, className: Accordion_module_css_1.default.Content }, props),
