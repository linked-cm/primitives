...
var Slider_module_css_1 = __importDefault(require("./Slider.module.css"));
...
var Track = extend(SliderPrimitive.Track, Slider_module_css_1.default.Track);
exports.Track = Track;
var Range = extend(SliderPrimitive.Range, Slider_module_css_1.default.Range);
exports.Range = Range;
var Thumb = extend(SliderPrimitive.Thumb, Slider_module_css_1.default.Thumb);
exports.Thumb = Thumb;
var Root = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(SliderPrimitive.Root, __assign({ ref: ref, className: (0, ClassNames_1.cl)(Slider_module_css_1.default.Root, className) }, props),
