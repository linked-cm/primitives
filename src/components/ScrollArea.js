...
var ScrollArea_module_css_1 = __importDefault(require("./ScrollArea.module.css"));
...
var Scrollbar = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(ScrollAreaPrimitive.ScrollAreaScrollbar, __assign({ ref: ref, orientation: orientation, className: (0, ClassNames_1.cl)(ScrollArea_module_css_1.default.Scrollbar, className) }, props),
...
var Root = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(ScrollAreaPrimitive.Root, __assign({ ref: ref, className: (0, ClassNames_1.cl)(ScrollArea_module_css_1.default.Root, className) }, props),
