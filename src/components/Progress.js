...
var Progress_module_css_1 = __importDefault(require("./Progress.module.css"));
...
var Indicator = extend(ProgressPrimitive.Indicator, Progress_module_css_1.default.Indicator);
exports.Indicator = Indicator;
var Root = React.forwardRef(function (_a, ref) {
    var className = _a.className, value = _a.value, props = __rest(_a, ["className", "value"]);
    return (React.createElement(ProgressPrimitive.Root, __assign({ ref: ref, className: (0, ClassNames_1.cl)(Progress_module_css_1.default.Root, className) }, props),
        React.createElement(Indicator, { className: Progress_module_css_1.default.Indicator, style: { transform: "translateX(-".concat(100 - (value || 0), "%)") } })));
});
exports.Root = Root;
