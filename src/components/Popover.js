...
var Popover_module_css_1 = __importDefault(require("./Popover.module.css"));
...
var Anchor = PopoverPrimitive.Anchor;
exports.Anchor = Anchor;
var Arrow = extend(PopoverPrimitive.Arrow, Popover_module_css_1.default.Arrow);
exports.Arrow = Arrow;
var Close = extend(PopoverPrimitive.Close, '');
exports.Close = Close;
var Content = React.forwardRef(function (_a, ref) {
    var className = _a.className, _b = _a.align, align = _b === void 0 ? 'center' : _b, _c = _a.sideOffset, sideOffset = _c === void 0 ? 4 : _c, children = _a.children, props = __rest(_a, ["className", "align", "sideOffset", "children"]);
    return (React.createElement(PopoverPrimitive.Portal, null,
        React.createElement(PopoverPrimitive.Content, __assign({ ref: ref, align: align, sideOffset: sideOffset, className: (0, ClassNames_1.cl)(Popover_module_css_1.default.Content, className) }, props),
            children,
