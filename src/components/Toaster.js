...
var use_toast_js_1 = require("../hooks/use-toast.js");
var Toast_js_1 = require("./Toast.js");
function Toaster() {
    var toasts = (0, use_toast_js_1.useToast)().toasts;
    return (React.createElement(Toast_js_1.Toast.Provider, null,
        toasts.map(function (_a) {
            ...
            return (React.createElement(Toast_js_1.Toast.Root, __assign({ key: id }, props),
