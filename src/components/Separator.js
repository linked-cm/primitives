...
var Separator_module_css_1 = __importDefault(require("./Separator.module.css"));
...
var Separator = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(SeparatorPrimitive.Root, __assign({ ref: ref, decorative: decorative, orientation: orientation, className: (0, ClassNames_1.cl)(Separator_module_css_1.default.Root, className) }, props)));
});
