...
var RadioGroup_module_css_1 = __importDefault(require("./RadioGroup.module.css"));
...
var Root = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(RadioGroupPrimitive.Root, __assign({ className: (0, ClassNames_1.cl)(RadioGroup_module_css_1.default.Root, className) }, props, { ref: ref })));
});
exports.Root = Root;
Root.displayName = RadioGroupPrimitive.Root.displayName;
var Item = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(RadioGroupPrimitive.Item, __assign({ ref: ref, className: (0, ClassNames_1.cl)(RadioGroup_module_css_1.default.Item, className) }, props),
