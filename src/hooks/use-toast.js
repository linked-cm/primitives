...
var reducer = function (state, action) {
    switch (action.type) {
        case 'ADD_TOAST':
            return __assign(__assign({}, state), { toasts: __spreadArray([action.toast], __read(state.toasts), false).slice(0, TOAST_LIMIT) });
        case 'UPDATE_TOAST':
...
function useToast() {
    var _a = __read(React.useState(memoryState), 2), state = _a[0], setState = _a[1];
